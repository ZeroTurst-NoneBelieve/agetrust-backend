...
class AuthError(StrEnum):
    ...
    OTP_LOCKED_UNTIL_EXPIRY = "OTP_LOCKED_UNTIL_EXPIRY"
    ...
    KIOSK_KEY_NOT_FOUND = "KIOSK_KEY_NOT_FOUND"
    KIOSK_KEY_REVOKED = "KIOSK_KEY_REVOKED"
    KIOSK_KEY_EXPIRY_INVALID = "KIOSK_KEY_EXPIRY_INVALID"
    KIOSK_IDENTIFIER_CONFLICT = "KIOSK_IDENTIFIER_CONFLICT"
    KIOSK_KEY_CONFLICT = "KIOSK_KEY_CONFLICT"
